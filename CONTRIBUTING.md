...
same executable path that produces the research verdict. Engineering-validation evidence must show
every registered control as passed and the complete receipt test run with zero skipped cases.
